...
//SKillmate suggested code
function showAndHide(hole, delay) {
  // Call the toggleVisibility function to add the 'show' class.
  toggleVisibility(hole);

  // Set a timeout to call the toggleVisibility function to remove the 'show' class after the specified delay.
  var timeoutID = setTimeout(function () {
    toggleVisibility(hole); // This will hide the mole
    gameOver(); // This function will be called after the mole is hidden.
  }, delay); // Use the delay parameter to control when the mole is hidden
